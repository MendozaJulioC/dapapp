...
export default function Example() {
  ...
  return (
    <>
      {/* <div className="p-40">
        <button type="button" className="text-gray-900  font-normal hover:font-bold bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100  rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 mr-4 mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#1A5D1A" class="bi bi-file-diff-fill mr-2 ml-2" viewBox="0 0 16 16">
        ...
        <button type="button"
          ...
          className="relative inline-flex items-center justify-center p-2.5 mb-2 mr-2 overflow-hidden text-sm   text-white font-medium
          rounded-lg group bg-gradient-to-br from-gray-600 to-blue-500
           group-hover:from-cyan-600 group-hover:to-blue-500 hover:text-white dark:text-white 
           focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-red-900">
          <svg class="w-4 h-4 mr-2 -ml-1 text-[#d7d8e2]" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="ethereum" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
        ...
        <button
          ...
          className="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium
           text-gray-900 rounded-lg group bg-gradient-to-br from-orange-600 to-blue-500
        ...
        <button
          onClick={() => setOpen(true)}
          className="bg-gray-100 rounded-lg border-2 hover:bg-emerald-500 border-gray-950 p-2 px-3"
          type="button"
        >
          {" "}
          activar{" "}
                  ...
                  <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:items-stretch">
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-center">
                        ...
                        >
                          <h2 className="mt-3 mb-3 text-center text-2xl font-bold leading-6 tracking-tight text-gray-900">
                            ...
                            <div className="mt-2">
                              ...
                              >
                                ...
                                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-4">
                                  <div>
                                    <label
                                      ...
                                      className="block text-sm font-semibold leading-6 text-gray-900"
                                    >
                                      Tipo de Proyectojjjjjj
                                    </label>
                                    <div className="mt-2.5">
                                      <select className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rose-400 sm:text-sm sm:leading-6">
                                ...
                                <div className="mt-10">
                                  <button
                                    type="submit"
                                    className="block w-full rounded-md bg-rose-400 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                  >
                                    Let's talk
                                  </button>
                                </div>

    ...
    <div className=" bg-white px-6 py-24 sm:py-32 lg:px-8 container mx-auto">
      ...
      <form action="#" method="POST" className="mx-auto mt-4 py-4">
        <div className="grid grid-cols-1 gap-x-8  gap-y-6 sm:grid-cols-5">
          ...
          <div>
            <div className="mt-9">
              <button className="flex justify-center rounded-md bg-rose-400  px-10 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">
                Buscar
              </button>
            </div>
          </div>
        ...
        <br />
        <hr className="  border-1  border-rose-400" />
        ...
        <hr className="  border-1  border-rose-400 mb-2 mt-2" />

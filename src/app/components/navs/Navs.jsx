...
const navigation = [
  ...
  {
    name: "DAP",
    href: "https://www.medellin.gov.co/es/departamento-administrativo-de-planeacion/",
  },
  ...
  return (
    <div className="bg-white">
      <header className="  fixed  inset-x-0 top-0 z-50">
        <nav
          className="flex bg-gray-100 items-center fixed top-0  inset-x-0  z-50 justify-between p-2 lg:px-6"
          aria-label="Global"
        >
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <div className=" flex items-center justify-between p-6 lg:px-20">
              <Dropdown
                ...
                label={
                  <Avatar
                    ...
                    bordered
                  >
                    <div className="space-y-1 mr-4 font-medium dark:text-white">
                      <div>
                        {" "}
              ...
              >
                <Dropdown.Header>
                  <span className="block text-sm"> {props.usuario}</span>
